...
public class QualitativeCheckMasterController {
    ...
    @Operation(summary = "Get all Qualitative Check Masters with pagination")
    ...
    public ResponseEntity<Response<List<QualitativeCheckMasterDTOResponse>>> getAll(
        ...
        Page<QualitativeCheckMasterDTOResponse> resultPage = service.getAllQualitativeCheckMasters(PageRequest.of(page - 1, size));
        return responseService.success(HttpStatus.OK.value(), "Qualitative Check Masters fetched successfully", resultPage.getContent(), resultPage.getTotalElements());
    }
